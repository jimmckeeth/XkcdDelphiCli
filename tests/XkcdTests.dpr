...
uses
  ...
  testXkcdDb in 'testXkcdDb.pas',
  testXkcdExplained in 'testXkcdExplained.pas',
  testXkcdConsole in 'testXkcdConsole.pas',
  testTermImageColor in 'testTermImageColor.pas',
